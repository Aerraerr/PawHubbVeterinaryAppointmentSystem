 ...
 * @author Aeron
 */
public class beforeAdmin extends javax.swing.JFrame {
    
    public beforeAdmin(String username) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(toBook, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 600, 460, 49));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 310, 380, 110));
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 660, 110));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 760, 140, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beforeAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new beforeAdmin().setVisible(true);
